...
#     do
#         echo "mplayer ${MPLAYERCROP} -sb $STEP ${INPUT} ${DEBUG2}" >> ${CROPLOG} 
#         mplayer ${MPLAYERCROP} -sb $STEP ${INPUT} ${DEBUG2} >> ${CROPLOG} 2>&1
#     done
